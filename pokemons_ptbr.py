...
class CriaPokemon():
    ...
    def mostra_pokemon(self):
        print(f"\n\033[1;31m\n            {self.numero}\033[m")
        print(f"\n\033[1;31mNome:\033[m \033[1;37m{self.nome}  \033[1;31m / Tipo: \033[1;37m{self.tipo}\033[m")
        print(f"\n\033[1;31mAtaques:\033[m \033[1;37m{self.ataques}\033[m")
        print(f"\n\033[1;31mDescrição:\033[m \033[1;37m{self.descricao}\033[m")
        print(f"\n\033[1;31mEvolução anterior:\033[m \033[1;37m{self.evolucao_anterior}\033[m")
        print(f"\n\033[1;31mPróxima evolução:\033[m \033[1;37m{self.proxima_evolucao}\033[m")
