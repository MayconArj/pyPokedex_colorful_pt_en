...
class CreatePokemon():
    ...
    def show_pokemon(self):
        print(f"\n\033[1;31m\n            {self.number}\033[m")
        print(f"\n\033[1;31mName:\033[m \033[1;37m{self.name}  \033[1;31m / Type: \033[1;37m{self.type}\033[m")
        print(f"\n\033[1;31mMoves:\033[m \033[1;37m{self.attacks}\033[m")
        print(f"\n\033[1;31mDesc:\033[m \033[1;37m{self.description}\033[m")
        print(f"\n\033[1;31mPrevious Evolution:\033[m \033[1;37m{self.previous_evolution}\033[m")
        print(f"\n\033[1;31mNext Evolution:\033[m \033[1;37m{self.next_evolution}\033[m")
