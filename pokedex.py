...
print("\033[1;33m    _.----.        ____         ,'  _\   ___    ___     ____       \033[m")
print("\033[1;33m_,-'       `.     |    |  /`.   \,-'    |   \  /   |   |    \  |`. \033[m")
print("\033[1;33m\      __    \    '-.  | /   `.  ___    |    \/    |   '-.   \ |  |\033[m")
print("\033[1;33m \.    \ \   |  __  |  |/    ,','_  `.  |          | __  |    \|  |\033[m")
print("\033[1;33m   \    \/   /,' _`.|      ,' / / / /   |          ,' _`.|     |  |\033[m")
print("\033[1;33m    \     ,-'/  /   \    ,'   | \/ / ,`.|         /  /   \  |     |\033[m")
print("\033[1;33m     \    \ |   \_/  |   `-.  \    `'  /|  |    ||   \_/  | |\    |\033[m")
print("\033[1;33m      \    \ \      /       `-.`.___,-' |  |\  /| \      /  | |   |\033[m")
print("\033[1;33m       \    \ `.__,'|  |`-._    `|      |__| \/ |  `.__,'|  | |   |\033[m")
print("\033[1;33m        \_.-'       |__|    `-._ |              '-.|     '-.| |   |\033[m")
print("\033[1;33m                                `'                            '-._|\033[m")
                                            
                                            
def menu():
    
    print("\n\n                                     \033[1;4;36mCreated by Maycon Douglas\033[m")

    print("\033[1;37m\nSeja Bem vindo a sua Pokedex!\033[m")
    print("\033[1;37mWelcome to your Pokedex!\033[m")

    print("\n\033[1;37mDigite [\033[1;31mSobre\033[m\033[1;37m] para saber mais sobre o programa.\033[m")
    print("\n\033[1;37mType [\033[1;31mAbout\033[m\033[1;37m] to learn more about the program\033[m")

    print("\n\n\033[1;37mDigite [\033[1;31mSair\033[m\033[1;37m] para fechar a Pokedex.\033[m")
    print("\n\033[1;37mType [\033[1;31mQuit\033[m\033[1;37m] to close the Pokedex.\033[m")

    print("\n\n\033[1;37mQual idioma você deseja?\033[m")
    print("\033[1;37mWhich language do you prefer?\033[m")

    print("\n\n\033[1;37mDigite [\033[1;31mpt\033[m\033[1;37m] Para Português\033[m")
    print("\033[1;37mType [\033[1;31men\033[m\033[1;37m] for English\033[m")
...
while run == True:
    ...
    # PARA CÓDIGO EM PORTUGUÊS =====v
        ...
        run_pt = "y"
        while run_pt == "y":
            print("\n\n\n(\033[1;32mApenas pokémons da primeira geração disponíveis no momento.)\n\nDigite números de 1 à 151; ou digite o nome do Pokémon\033[m")
            print("\n\033[1;37mDigite \033[1;31m\"menu\"\033[1;37m para voltar a seleção de linguagem.\033[m")

            pokemon_desejado = input("\n\n\033[1;37mQual pokemon você deseja procurar?\033[m\n\n").lower().strip()
            
            if pokemon_desejado == "menu":
                run_pt = "n"

            elif pokemon_desejado == "sair":
                print("\n\n\033[1;33mAté logo !!\033[m")
                exit()

            elif pokemon_desejado == "quit":
                print("\n\n\033[1;33mSee you !!\033[m")
                exit()
                ...
                input("\n\n\033[1;36mAperte \"enter\" para continuar.\033[m")
                ...
                print("\033[1;31m\n\n**** Pokémon não encontrado ou comando inválido ****\033[m")
                input("\n\n\033[1;36mAperte \"enter\" para continuar.\033[m")
    ...
    # PARA CÓDIGO EM INGLÊS =====v
        ...
        run_en = "y"
        while run_en == "y":
            print("\n\n\n(\033[1;32m* Only first generation pokemon available at the moment.)\n\nEnter numbers from 1 to 151; or type the Pokemon's name *\033[m")
            print("\n\033[1;37mType \033[1;31m\"menu\"\033[1;37m to go back to language menu.\033[m")

            pokemon_desejado = input("\n\n\033[1;37mWhich pokemon do you want to look for?\033[m\n\n").lower().strip() ##############
            ...
            if pokemon_desejado == "menu":
                ...
                input("\n\n\033[1;36mPress \"enter\" to continue.\033[m")
                ...
                print("\n\n\033[1;31m**** Pokemon not found or invalid command ****\033[m")
                input("\n\n\033[1;36mPress \"enter\" to continue.\033[m")
        ...
        print("\n\n\033[1;31m**** Resposta inválida / Invalid answer ****\033[m")
        continue